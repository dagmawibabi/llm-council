...
2. You can change your Council of LLMs list, your reviewer LLM and your Chairman LLM in the `lib/models.ts` file 
...
4. Open the link in your browser and start chatting
